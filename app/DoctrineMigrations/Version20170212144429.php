 ...
 */
class Version20170212144429 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE job_candidacy (id INT AUTO_INCREMENT NOT NULL, status_id INT NOT NULL, updated_by INT DEFAULT NULL, closed_by INT DEFAULT NULL, offer_id INT DEFAULT NULL, candidate_id INT DEFAULT NULL, cv_id INT DEFAULT NULL, content LONGTEXT NOT NULL, decision LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_1E80B98C6BF700BD (status_id), UNIQUE INDEX UNIQ_1E80B98C16FE72E1 (updated_by), UNIQUE INDEX UNIQ_1E80B98C88F6E01 (closed_by), INDEX IDX_1E80B98C53C674EE (offer_id), INDEX IDX_1E80B98C91BD8781 (candidate_id), UNIQUE INDEX UNIQ_1E80B98CCFE419E2 (cv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, user_validation_id INT DEFAULT NULL, statut_id INT NOT NULL, cv_name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_B66FFE92A76ED395 (user_id), INDEX IDX_B66FFE924CA9E500 (user_validation_id), INDEX IDX_B66FFE92F6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_expense (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, user_validation_id INT DEFAULT NULL, statut_id INT DEFAULT NULL, creationDate DATETIME NOT NULL, modificationDate DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, beginDate DATETIME NOT NULL, endDate DATETIME NOT NULL, validationDate DATETIME DEFAULT NULL, INDEX IDX_753793ACA76ED395 (user_id), INDEX IDX_753793AC4CA9E500 (user_validation_id), INDEX IDX_753793ACF6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_vacation (id INT AUTO_INCREMENT NOT NULL, statut_id INT DEFAULT NULL, user_id INT NOT NULL, user_validation_id INT DEFAULT NULL, creationDate DATETIME NOT NULL, modificationDate DATETIME DEFAULT NULL, beginDate DATETIME NOT NULL, endDate DATETIME NOT NULL, nbDays INT NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_3573B75F6203804 (statut_id), INDEX IDX_3573B75A76ED395 (user_id), INDEX IDX_3573B754CA9E500 (user_validation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, avatar_id INT DEFAULT NULL, user_id INT DEFAULT NULL, pseudo VARCHAR(100) NOT NULL, gravatar TINYINT(1) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, zipcode VARCHAR(10) DEFAULT NULL, city VARCHAR(10) DEFAULT NULL, country VARCHAR(20) DEFAULT NULL, birth_date DATE DEFAULT NULL, other VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_D95AB40586CC499D (pseudo), UNIQUE INDEX UNIQ_D95AB40586383B10 (avatar_id), UNIQUE INDEX UNIQ_D95AB405A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE job_candidacy ADD CONSTRAINT FK_1E80B98C6BF700BD FOREIGN KEY (status_id) REFERENCES statut (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE job_candidacy DROP FOREIGN KEY FK_1E80B98C6BF700BD');
